    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ mb: { xs: 4, sm: 6, md: 8 } }}>
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            {/* Cooking Mode Card */}
            <Card elevation={2} sx={{ mb: { xs: 3, md: 4 }, borderRadius: 2 }}>
              <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                <Typography variant="h6" gutterBottom>
                  Cooking Mode
                </Typography>
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      ...
                      disabled={
                        activeStep === currentRecipe.instructions.length - 1
                      }
                    >
                      Next
                    </Button>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete "{currentRecipe.title}"? This action
            cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
